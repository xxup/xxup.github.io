        ...
        function refreshAIModelUI() {
          ...
          items.forEach(function (el) {
            if (
              ...
              el.dataset.model === aiState.currentModel
            ) {
