...
document.writeln("<li><input hidden=\'\' type=\'radio\' name=\'type\' id=\'type-whyy\' value=\'https://unsplash.dogedoge.com/s/photos/\' data-placeholder=\'Unsplash图牌探索\'><label for=\'type-whyy\'><span style=\'color:#003daa\'>Unsplash</span></label></li>");
...
document.writeln("<li><input hidden type=\'radio\'name=\'type\'id=\'type-Neets\'value=\'https://www.ted.com/search?q=\'data-placeholder=\'TED搜索\'><label for=\'type-Neets\'><span style=\'color:#003daa\'>TED</span></label></li>");
document.writeln("</ul>");
document.writeln("</div>");
