...
document.writeln("");
document.writeln("");
document.writeln( "<li><input checked hidden type='radio'name='type'id='type-maji'value='https://magi.com/search?q='data-placeholder='智能引擎'><label for='type-maji'><span style='color:#003daa'>MAGI</span></label></li>"
);
document.writeln("");
document.writeln("");
document.writeln("<li><input checked hidden type='radio'name='type'id='type-mijisou'value='https://mijisou.com/?q='data-placeholder='匿名搜索'><label for='type-mijisou'><span style='color:#003daa'>秘迹</span></label></li>"
);
document.writeln("");
